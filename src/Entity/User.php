 ...
 * @UniqueEntity(
 *          fields={"email"},
 *          message="Un compte existe déja avec cette adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Veuillez donnez une URL vide pour votre avatar")
     */
    private $picture;
    ...
    /**
     * @Assert\EqualTo(
     *     propertyPath = "hash", message="Vous n'avez pas correctement confirmé votre mot de passe."
     * )
     */
